# -*- coding: utf-8 -*-
#
# halive documentation build configuration file, created by
...
latex_documents = [
  ('index', 'halive.tex', u'halive Documentation',
   u'gnc', 'manual'),
]
...
man_pages = [
    ('index', 'halive', u'halive Documentation',
     [u'gnc'], 1)
]
